...
public class OpenWeatherCoordinateProvider : ICoordinateProvider
{
    private readonly ILogger<OpenWeatherCoordinateProvider> _logger;
    private readonly string _openWeatherApiKey;
    
    public OpenWeatherCoordinateProvider(ILogger<OpenWeatherCoordinateProvider> logger, IConfiguration configuration)
    {
        _logger = logger;
